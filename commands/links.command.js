    ...
    return {
        ...
        onCommand: (event, member, channel, args) => {
            let embed = new RichEmbed()
                ...
                .addField('KuCoin (Exchange)', 'https://kucoin.rocks | Awesome exchange which supports smaller coins and has a cool proof of stake system built-in with their own cryptocurrency.')
                .addField('Cryptopia (Exchange)', 'https://cryptopia.site | Another exchange - this one hosts much smaller coins and icos, but be careful which you invest in.')
