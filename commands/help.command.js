  ...
  return {
    ...
    onCommand: (event, member, channel, args) => {
      let embed = new RichEmbed()
        ...
        .setDescription(
          "Crypton is a bot made by Trophonix (Lucas#5300) for Cryptocurrency-related things. These are the commands currently available:"
        )
      ...
      embed.addField(
        ...
        "Join my support server: https://crypton.fun/support"
      );
